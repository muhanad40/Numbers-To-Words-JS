...
function NumbersToWords() {
	this.context = '';
	this.WORDS = 'hundred thousand million billion trillion gazillion'.split(" ");
	this.ONES = 'zero one two three four five six seven eight nine ten'.split(" ");
	this.TENS = 'eleven twelve thirteen fourteen fifteen sixteen seventeen eighteen nineteen twenty'.split(" ");
	this.MULTIPLES_OF_TEN = 'ten twenty thirty fourty fifty sixty seventy eighty ninty hundred'.split(" ");
}
